...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  MO(_LRAISE),  KC_LALT, KC_LGUI, MO(_FN),XXXXXXX,  KC_SPC,  KC_ENT,  KC_BSPC, KC_ESC,  MO(_RRAISE), KC_UP, MO(_RLOWER)\
),
...
[_LRAISE] = LAYOUT_ortho_4x12( \
  ...
  _______,     _______,_______,_______, _______, _______, S(KC_6),    S(KC_7),    S(KC_8),    S(KC_9),    S(KC_0),    _______,\
